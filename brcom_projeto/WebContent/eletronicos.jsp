<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <jsp:useBean class="br.com.brcom.managedbeans.ManagedBeanProdutoEletronico" id="mb"></jsp:useBean>
			...
			<span id="mensagemjanela"></span>
			 	<h2>Categorias</h2>
			      <ul class="nav nav-pills nav-stacked">
			     	<li><a href="/brcom_projeto/index.jsp">Início</a></li>
			        <li  class="active"><a href="/brcom_projeto/eletronicos.jsp">Eletrônicos</a></li>
			        <li><a href="/brcom_projeto/livros.jsp">Livros</a></li>
			        <li><a href="/brcom_projeto/jogos.jsp">Jogos</a></li>
			      </ul><br>
